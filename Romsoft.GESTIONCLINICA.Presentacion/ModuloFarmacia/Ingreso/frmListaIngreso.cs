...
{
    public partial class frmListaIngreso : Form
    {
        ...
        {
            Ingreso.frmFiltroIngreso frm = new Ingreso.frmFiltroIngreso();
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            Ingreso.frmNuevoIngreso frm = new Ingreso.frmNuevoIngreso();
